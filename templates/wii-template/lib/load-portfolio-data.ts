...
import type { Project } from "./channels"
...
// Filters projects by channel category
export function getProjectsByCategory(projects: Project[], categoryId: string): Project[] {
  return projects.filter((project) => {
    return project.category && project.category.includes(categoryId)
  })
}
